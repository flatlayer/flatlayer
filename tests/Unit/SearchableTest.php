...
class SearchableTest extends TestCase
{
    ...
    public function test_update_search_vector()
    {
        ...
        $this->assertCount(1536, $entry->embedding->toArray());
    }
    ...
    public function test_search_without_reranking()
    {
        ...
        $results = Entry::search('test document', 2);

        $this->assertCount(2, $results);
        $this->assertTrue(isset($results[0]->relevance), 'First result should have a relevance attribute');
        $this->assertTrue(isset($results[1]->relevance), 'Second result should have a relevance attribute');
        $this->assertNotEquals($results[0]->relevance, $results[1]->relevance);
